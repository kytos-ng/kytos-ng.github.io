...
QinQ had been removed from `mef_eline` due to the lack of compatibility from Noviflow switches. The feature has been reintroduced by setting the customer VLAN on the ingress when pushing the QinQ encapsulation since this action is correctly supported by OvS and NoviFlow switches.
...
### 4. Kytos core queues improvements and event message prioritization
...
### 9. Increase unit test coverage to 85% on `coloring`, `sdntrace` and `sdntrace_cp`
...
- [202 pull requests were merged](https://github.com/search?q=org%3Akytos-ng+is%3Apr+is%3Aclosed+merged%3A2022-02-11..2022-08-31&type=Issues)
- [80 issues were closed](https://github.com/search?q=org%3Akytos-ng+is%3Aissue+label%3A2022.2+is%3Aclosed&type=Issues)
