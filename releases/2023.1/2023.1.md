...
### 4. Migrate `@rest` decorated routes from `werkzeug/flask` to `uvicorn/starlette`
...
### 5. Stabilize `sdntrace_cp` and general improvements
...
### 6. General UI fixes and enhancements 
...
<!---
TODO ask Rogerio if he wants to include anything else or screenshots
-->

### 7. General core enhancements and endpoints OpenAPI validations
...
- `pathfinder`
- `of_multi_table`
- `mef_eline` (had already been using OpenAPI validations, but now it has included validations on additional endpoints)

### 8. Specify requirements for `mef_eline` VLAN range feature and consolidated Kytos-ng documentation
...
### 9. Upgrade and simplify core development dependencies
...
<!---
TODO remove this comment and move maintenance to the table above once 2023.1.1 is released
...
- [172 pull requests were merged](https://github.com/search?q=org%3Akytos-ng+is%3Apr+is%3Aclosed+merged%3A2023-02-01..2023-07-10&type=Issues)
- [116 issues were closed](https://github.com/search?q=org%3Akytos-ng+is%3Aissue+is%3Aclosed+closed%3A2023-02-01..2023-07-10+label%3A2023.1&type=issues)
